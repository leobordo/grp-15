...
<ul class="navbarElement" style="display: flex; align-items:center">   
    <li>
      <div class="homeButton" style="height: 48px">
        
        <img class="icona"  src="{{ asset('images\Icona web.svg') }}" alt="logo" >
      </div>
    </li>
    ...
    @guest
      <li style="margin-left: auto"><a href="{{ route('register') }}" title="Iscriviti se non lo hai fatto">Iscriviti</a></li>
